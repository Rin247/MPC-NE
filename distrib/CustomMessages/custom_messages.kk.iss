...
msg_DeleteSettings=Do you also want to delete MPC-NE settings?%n%nIf you plan on installing MPC-NE again then you do not have to delete them.
...
msg_SetupIsRunningWarning=MPC-NE setup is already running!
msg_simd_sse2=This build of MPC-NE requires a CPU with SSE2 extension support.%n%nYour CPU does not have those capabilities.
