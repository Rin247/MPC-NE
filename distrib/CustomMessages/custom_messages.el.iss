...
el.msg_DeleteSettings=Θέλετε να διαγράψετε τις ρυθμίσεις του MPC-NE;%n%nΑν σκοπεύετε να εγκαταστήσετε το MPC-NE πάλι τότε δεν χρειάζεται να τις διαγράψετε.
...
el.msg_SetupIsRunningWarning=Η εγκατάσταση του MPC-NE εκτελείται ήδη!
el.msg_simd_sse2=Αυτή η έκδοση του MPC-NE απαιτεί επεξεργαστή CPU με υποστήριξη SSE2.%n%nΟ επεξεργαστής σας δεν το υποστηρίζει.
