...
ro.tsk_LongPathsEnable=Activează suportul pentru căile lungi pentru Windows 10
...
ro.AssociationMPCPlayCDAudioOnArrivalF=Redă CD-urile audio
ro.AssociationMPCPlayCDAudioS=CD audio
ro.AssociationMPCPlayDVDMovieArrivalF=Redă filmele de pe DVD
ro.AssociationMPCPlayDVDMovieS=Film de pe DVD
ro.AssociationMPCPlayMusicFilesF=Redă muzica
