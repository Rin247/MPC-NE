...
it.msg_DeleteSettings=Vuoi eliminare anche le impostazioni di MPC-NE?%n%nSe prevedi di installare nuovamente MPC-NE, non devi eliminarle.
...
it.msg_SetupIsRunningWarning=L'installazione di MPC-NE è già in esecuzione!
it.msg_simd_sse2=Questa build di MPC-NE richiede una CPU con supporto per l'estensione SSE2.%n%nLa tua CPU non ha queste capacità.
it.tsk_AllUsers=Per tutti gli utenti
it.tsk_CurrentUser=Solo per l'attuale utente
it.tsk_Other=Altre operazioni:
it.tsk_LongPathsEnable=Abilita il supporto per i percorsi lunghi di Windows 10
